...
func decompressPoint(curve *KoblitzCurve, x *big.Int, ybit bool) (*big.Int, error) {
	// TODO: This will probably only work for secp256k1 due to optimizations.
...
func IsCompressedPubKey(pubKey []byte) bool {
	...
	return len(pubKey) == PubKeyBytesLenCompressed &&
		(pubKey[0]&pubkeyCompressed == pubkeyCompressed)
...
/*
Description:
PubKey is an ecdsa.PubKey with additional functions to
...
// IsEqual compares this PubKey instance to the one passed, returning true if
// both PublicKeys are equivalent. A PubKey is equivalent to another, if they
