...
func DecodeWIF(wif string) (*WIF, error) {
	...
	privKey, _ := NewPrivKeyFromBytes(S256(), privKeyBytes)
	return &WIF{privKey, compress, Magic(netID)}, nil
}
